const Footer = () => {
  return (
    <footer className='flex flex-col mx-auto gap-10 mb-5 max-w-[1169px] sticky top-[100vh]'>
      <div>
        <h3 className='mt-10 mb-5 text-[#3D56D9] text-xl md:text-2xl text-cneter font-bold'>
